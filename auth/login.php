        ...
        if(empty($_POST['email']) OR empty($_POST['password'])){
            ...
            if($login->rowCount()>0){
                ...
                if(password_verify($password,$fetch['password'])){
                   ...
                   // header("Location:".APPURAL."/auth/login.php");
...
?>
    ...
    <section class="normal-breadcrumb set-bg" data-setbg="<?php echo APPURAL; ?>/img/normal-breadcrumb.jpg">
        <div class="container">
            <div class="row">
